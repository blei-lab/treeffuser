...
def test_data_validation():
    ...
    # Unidimensional response and covariate
    fit_and_validate_model(x_train, y_train, x_test, y_test, flatten_x=True, flatten_y=True)

    # Unidimensional response only
    fit_and_validate_model(x_train, y_train, x_test, y_test, flatten_x=False, flatten_y=True)

    # Unidimensional covariate only
    fit_and_validate_model(x_train, y_train, x_test, y_test, flatten_x=True, flatten_y=False)
